...
class A2C:
    ...
    def update_exp(self,
        ...
        advantages = policy_storage.returns_exp[:-1] - policy_storage.value_preds_exp[:-1]
        ...
        policy_storage.before_update_exp(self.actor_critic)

        data_generator = policy_storage.feed_forward_generator_exp(advantages, 1)
