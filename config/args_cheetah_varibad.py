...
def get_args(rest_args):
    ...
    parser.add_argument('--IR_type', type=str, default='none', help='KL, var red, euclidian, rew_pred, trans pred, none')
    parser.add_argument('--task_dim', type=int, default=1,
                        help='dimensionality of task description')
    ...
    parser.add_argument('--env_name', default='Cheetah-v0', help='environment to train on')
    ...
    parser.add_argument('--vae_batch_num_trajs', type=int, default=4,
